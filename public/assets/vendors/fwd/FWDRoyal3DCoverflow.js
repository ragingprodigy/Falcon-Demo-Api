(window._gsQueue || (window._gsQueue = [])).push(function() {
    "use strict";
    var e = /(\d|\.)+/g, t = {aqua: [0, 255, 255],lime: [0, 255, 0],silver: [192, 192, 192],black: [0, 0, 0],maroon: [128, 0, 0],teal: [0, 128, 128],blue: [0, 0, 255],navy: [0, 0, 128],white: [255, 255, 255],fuchsia: [255, 0, 255],olive: [128, 128, 0],yellow: [255, 255, 0],orange: [255, 165, 0],gray: [128, 128, 128],purple: [128, 0, 128],green: [0, 128, 0],red: [255, 0, 0],pink: [255, 192, 203],cyan: [0, 255, 255],transparent: [255, 255, 255, 0]}, n = function(e, t, n) {
        ...
        if ("#" === r.charAt(0))
            return 4 === r.length && (r = "#" + r.charAt(1) + r.charAt(1) + r.charAt(2) + r.charAt(2) + r.charAt(3) + r.charAt(3)), r = parseInt(r.substr(1), 16), [r >> 16, 255 & r >> 8, 255 & r];
        if ("hsl" === r.substr(0, 3)) {
            r = r.match(e);
            var s = Number(r[0]) % 360 / 360, o = Number(r[1]) / 100, u = Number(r[2]) / 100, a = .5 >= u ? u * (o + 1) : u + o - u * o, f = 2 * u - a;
            return r.length > 3 && (r[3] = Number(r[3])), r[0] = n(s + 1 / 3, f, a), r[1] = n(s, f, a), r[2] = n(s - 1 / 3, f, a), r
        }
        return r.match(e) || t.transparent
    };
    window._gsDefine.plugin({propName: "colorProps",priority: -1,API: 2,init: function(e, t) {
        this._target = e;
        var n, i, o, u;
        for (n in t)
            o = r(t[n]), this._firstPT = u = {_next: this._firstPT,p: n,f: "function" == typeof e[n],n: n,r: !1}, i = r(u.f ? e[n.indexOf("set") || "function" != typeof e["get" + n.substr(3)] ? n : "get" + n.substr(3)]() : e[n]), u.s = Number(i[0]), u.c = Number(o[0]) - u.s, u.gs = Number(i[1]), u.gc = Number(o[1]) - u.gs, u.bs = Number(i[2]), u.bc = Number(o[2]) - u.bs, (u.rgba = i.length > 3 || o.length > 3) && (u.as = 4 > i.length ? 1 : Number(i[3]), u.ac = (4 > o.length ? 1 : Number(o[3])) - u.as), u._next && (u._next._prev = u);
        return !0
    },set: function(e) {
        for (var t, n = this._firstPT; n; )
            t = (n.rgba ? "rgba(" : "rgb(") + (n.s + e * n.c >> 0) + ", " + (n.gs + e * n.gc >> 0) + ", " + (n.bs + e * n.bc >> 0) + (n.rgba ? ", " + (n.as + e * n.ac) : "") + ")", n.f ? this._target[n.p](t) : this._target[n.p] = t, n = n._next
    }})
...
(function(e) {
    var t = function(n, r) {
        ...
        this.setupMainContainers = function() {
            var e;
            i.mainHolder_do = new FWDR3DCovDisplayObject("div");
            i.mainHolder_do.setOverflow("visible");
            i.addChild(i.mainHolder_do);
            i.mainButtonsHolder_do = new FWDR3DCovDisplayObject("div");
            i.mainButtonsHolder_do.setY(i.buttonHeight);
            i.mainHolder_do.addChild(i.mainButtonsHolder_do);
            i.buttonsHolder_do = new FWDR3DCovDisplayObject("div");
            i.mainButtonsHolder_do.addChild(i.buttonsHolder_do);
            FWDR3DCovComboBoxSelector.setPrototype();
            i.selector_do = new FWDR3DCovComboBoxSelector(i.arrowW, i.arrowH, i.arrowN_str, i.arrowS_str, i.selectorLabel_str, i.selectorBkColorN_str1, i.selectorBkColorS_str1, i.selectorBkColorN_str2, i.selectorBkColorS_str2, i.selectorTextColorN_str, i.selectorTextColorS_str, i.buttonHeight);
            ...
            i.selector_do.addListener(FWDR3DCovComboBoxSelector.MOUSE_DOWN, i.openMenuHandler);
            for (var t = 0; t < i.totalButtons; t++) {
                FWDR3DCovComboBoxButton.setPrototype();
                e = new FWDR3DCovComboBoxButton(i.categories_ar[t], i.itemBkColorN_str1, i.itemBkColorS_str1, i.itemBkColorN_str2, i.itemBkColorS_str2, i.itemTextColorN_str, i.itemTextColorS_str, t, i.buttonHeight);
                i.buttons_ar[t] = e;
                e.addListener(FWDR3DCovComboBoxButton.MOUSE_DOWN, i.buttonOnMouseDownHandler);
        ...
        this.checkOpenedMenu = function(t) {
            if (t.preventDefault)
                t.preventDefault();
            var n = FWDR3DCovUtils.getViewportMouseCoordinates(t);
            if (!FWDR3DCovUtils.hitTest(i.screen, n.screenX, n.screenY)) {
                if (i.isMobile_bl) {
                    i.hide(true);
                    i.selector_do.enable()
                } else {
        ...
        i.getMaxWidthResizeAndPosition = function() {
            ...
            for (var r = 0; r < i.totalButtons; r++) {
                e = i.buttons_ar[r];
                if (e.getMaxTextWidth() > i.totalWidth)
                    i.totalWidth = e.getMaxTextWidth()
            }
            for (var r = 0; r < i.totalButtons; r++) {
                e = i.buttons_ar[r];
        ...
        this.showFirstTime = function() {
            ...
            FWDR3DCovModTweenMax.to(i.mainHolder_do, .8, {y: 0,ease: Expo.easeInOut})
        };
        this.hide = function(e, t) {
            ...
            if (e) {
                FWDR3DCovModTweenMax.to(i.buttonsHolder_do, .6, {y: -i.totalButtonsHeight,ease: Expo.easeInOut});
                FWDR3DCovModTweenMax.to(i.mainButtonsHolder_do, .6, {h: 0,ease: Expo.easeInOut});
                FWDR3DCovModTweenMax.to(i, .6, {h: i.buttonHeight,ease: Expo.easeInOut})
            } else {
        ...
        this.show = function(e, t) {
            ...
            if (e) {
                FWDR3DCovModTweenMax.to(i.buttonsHolder_do, .6, {y: 0,ease: Expo.easeInOut});
                FWDR3DCovModTweenMax.to(i.mainButtonsHolder_do, .6, {h: i.totalButtonsHeight + i.buttonHeight,ease: Expo.easeInOut});
                FWDR3DCovModTweenMax.to(i, .6, {h: i.totalButtonsHeight + i.buttonHeight,ease: Expo.easeInOut})
            } else {
        ...
        this.destroy = function() {
            ...
            FWDR3DCovModTweenMax.killTweensOf(i);
            FWDR3DCovModTweenMax.killTweensOf(i.mainHolder_do);
            FWDR3DCovModTweenMax.killTweensOf(i.buttonsHolder_do);
            FWDR3DCovModTweenMax.killTweensOf(i.mainButtonsHolder_do);
...
(function() {
    var e = function(t, n, r, i, s, o, u, a, f) {
        ...
        this.colorObj = {color1: l.backgroundNormalColor_str1,color2: l.backgroundNormalColor_str2};
        l.init = function() {
        ...
        l.setupMainContainers = function() {
            l.bk_sdo = new FWDR3DCovSimpleDisplayObject("div");
            l.bk_sdo.setCSSGradient(l.backgroundNormalColor_str1, l.backgroundNormalColor_str2);
            l.addChild(l.bk_sdo);
            l.text_sdo = new FWDR3DCovSimpleDisplayObject("div");
            ...
            l.dumy_sdo = new FWDR3DCovSimpleDisplayObject("div");
        ...
        l.onMouseOver = function(t) {
            ...
            if (!t.pointerType || t.pointerType == t.MSPOINTER_TYPE_MOUSE) {
                FWDR3DCovModTweenMax.killTweensOf(l.text_sdo);
        ...
        l.onMouseDown = function(t) {
            ...
            if (t.preventDefault)
                t.preventDefault();
            l.dispatchEvent(e.MOUSE_DOWN, {e: t})
        };
        this.setSelectedState = function(e) {
            if (e) {
                FWDR3DCovModTweenMax.to(l.colorObj, .6, {colorProps: {color1: l.backgroundSelectedColor_str1,color2: l.backgroundSelectedColor_str2},ease: Quart.easeOut,onUpdate: l.applyProps});
                FWDR3DCovModTweenMax.to(l.text_sdo.screen, .6, {css: {color: l.textSelectedColor_str},ease: Quart.easeOut})
            } else {
        ...
        this.setNormalState = function(e) {
            if (e) {
                FWDR3DCovModTweenMax.to(l.colorObj, .6, {colorProps: {color1: l.backgroundNormalColor_str1,color2: l.backgroundNormalColor_str2},ease: Quart.easeOut,onUpdate: l.applyProps});
                FWDR3DCovModTweenMax.to(l.text_sdo.screen, .6, {css: {color: l.textNormalColor_str},ease: Quart.easeOut})
            } else {
        ...
        l.destroy = function() {
            ...
            FWDR3DCovModTweenMax.killTweensOf(l.text_sdo.screen);
            FWDR3DCovModTweenMax.killTweensOf(l.bk_sdo.screen);
            l.text_sdo.destroy();
            l.bk_sdo.destroy();
            l.dumy_sdo.destroy();
            l.bk_sdo = null;
    ...
    e.setPrototype = function() {
        e.prototype = new FWDR3DCovDisplayObject("div")
    };
    ...
    e.CLICK = "onClick";
    e.prototype = null;
    window.FWDR3DCovComboBoxButton = e
})(window);
(function() {
    var e = function(t, n, r, i, s, o, u, a, f, l, c, h) {
        ...
        this.isMobile_bl = FWDR3DCovUtils.isMobile;
        this.isDisabled_bl = false;
        this.colorObj = {color1: p.backgroundNormalColor_str1,color2: p.backgroundNormalColor_str2};
        p.init = function() {
        ...
        p.setupMainContainers = function() {
            p.bk_sdo = new FWDR3DCovSimpleDisplayObject("div");
            p.bk_sdo.setCSSGradient(p.backgroundNormalColor_str1, p.backgroundNormalColor_str2);
            p.addChild(p.bk_sdo);
            p.text_sdo = new FWDR3DCovSimpleDisplayObject("div");
            ...
            p.arrowN_sdo = new FWDR3DCovSimpleDisplayObject("div");
            p.arrowN_sdo.screen.style.backgroundImage = "url(" + p.arrowN_str + ")";
            p.arrowS_sdo = new FWDR3DCovSimpleDisplayObject("div");
            ...
            p.dumy_sdo = new FWDR3DCovSimpleDisplayObject("div");
            if (FWDR3DCovUtils.isIE) {
        ...
        p.onMouseOver = function(t) {
            if (p.isDisabled_bl)
                return;
            if (!t.pointerType || t.pointerType == t.MSPOINTER_TYPE_MOUSE) {
                FWDR3DCovModTweenMax.killTweensOf(p.text_sdo);
        ...
        p.onMouseDown = function(t) {
            ...
            if (t.preventDefault)
                t.preventDefault();
            p.dispatchEvent(e.MOUSE_DOWN, {e: t})
        };
        this.setSelectedState = function(e) {
            if (e) {
                FWDR3DCovModTweenMax.to(p.colorObj, .6, {colorProps: {color1: p.backgroundSelectedColor_str1,color2: p.backgroundSelectedColor_str2},ease: Quart.easeOut,onUpdate: p.applyProps});
                FWDR3DCovModTweenMax.to(p.text_sdo.screen, .6, {css: {color: p.textSelectedColor_str},ease: Quart.easeOut});
                FWDR3DCovModTweenMax.to(p.arrowS_sdo, .6, {alpha: 1,ease: Quart.easeOut})
            } else {
        ...
        this.setNormalState = function(e) {
            if (e) {
                FWDR3DCovModTweenMax.to(p.colorObj, .6, {colorProps: {color1: p.backgroundNormalColor_str1,color2: p.backgroundNormalColor_str2},ease: Quart.easeOut,onUpdate: p.applyProps});
                FWDR3DCovModTweenMax.to(p.text_sdo.screen, .6, {css: {color: p.textNormalColor_str},ease: Quart.easeOut});
                FWDR3DCovModTweenMax.to(p.arrowS_sdo, .6, {alpha: 0,ease: Quart.easeOut})
            } else {
        ...
        this.disable = function() {
            ...
            p.setSelectedState(true);
            if (FWDR3DCovUtils.hasTransform2d) {
                FWDR3DCovModTweenMax.to(p.arrowN_sdo.screen, .6, {css: {rotation: 180},ease: Quart.easeOut});
                FWDR3DCovModTweenMax.to(p.arrowS_sdo.screen, .6, {css: {rotation: 180},ease: Quart.easeOut})
            }
        ...
        this.enable = function() {
            ...
            p.setNormalState(true);
            if (FWDR3DCovUtils.hasTransform2d) {
                FWDR3DCovModTweenMax.to(p.arrowN_sdo.screen, .6, {css: {rotation: 0},ease: Quart.easeOut});
                FWDR3DCovModTweenMax.to(p.arrowS_sdo.screen, .6, {css: {rotation: 0},ease: Quart.easeOut})
            }
            p.setButtonMode(true)
        };
        ...
        p.destroy = function() {
            ...
            FWDR3DCovModTweenMax.killTweensOf(p.text_sdo);
            FWDR3DCovModTweenMax.killTweensOf(p.colorObj);
            p.text_sdo.destroy();
            p.dumy_sdo.destroy();
            p.text_sdo = null;
            p.dumy_sdo = null;
    ...
    e.CLICK = "onClick";
    e.prototype = null;
    window.FWDR3DCovComboBoxSelector = e
})(window);
(function(e) {
    var t = function(e, n, r, i, s, o) {
        ...
        this.setupMainContainers = function() {
            this.firstButton_do = new FWDR3DCovDisplayObject("div");
            this.addChild(this.firstButton_do);
            this.n1_do = new FWDR3DCovDisplayObject("img");
            this.n1_do.setScreen(this.n1Img);
            this.s1_do = new FWDR3DCovDisplayObject("img");
            ...
            this.secondButton_do = new FWDR3DCovDisplayObject("div");
            this.addChild(this.secondButton_do);
            this.n2_do = new FWDR3DCovDisplayObject("img");
            this.n2_do.setScreen(this.n2Img);
            this.s2_do = new FWDR3DCovDisplayObject("img");
        ...
        this.onMouseOver = function(e) {
            if (!e.pointerType || e.pointerType == e.MSPOINTER_TYPE_MOUSE) {
                FWDR3DCovModTweenMax.killTweensOf(u.n1_do);
                FWDR3DCovModTweenMax.killTweensOf(u.n2_do);
                FWDR3DCovModTweenMax.to(u.n1_do, .8, {alpha: 0,ease: Expo.easeOut});
                FWDR3DCovModTweenMax.to(u.n2_do, .8, {alpha: 0,ease: Expo.easeOut})
            }
        };
        this.onMouseOut = function(e) {
            if (!e.pointerType || e.pointerType == e.MSPOINTER_TYPE_MOUSE) {
                ...
                if (u.isMaximized_bl)
                    t = 1;
                FWDR3DCovModTweenMax.to(u.n1_do, .8, {alpha: 1,delay: t,ease: Expo.easeOut});
                FWDR3DCovModTweenMax.to(u.n2_do, .8, {alpha: 1,delay: t,ease: Expo.easeOut})
            }
        };
...
(function() {
    var e = function(e, t) {
        ...
        this.contextMenuWindowOnMouseDownHandler = function(e) {
            var t = FWDR3DCovUtils.getViewportMouseCoordinates(e);
            var r = t.screenX;
            var i = t.screenY;
            if (!FWDR3DCovUtils.hitTest(n.menu_do.screen, r, i)) {
        ...
        this.setupMenus = function() {
            if (this.menu_do)
                return;
            this.menu_do = new FWDR3DCovDisplayObject("div");
            n.menu_do.setX(-500);
            this.menu_do.getStyle().width = "100%";
            this.normalMenu_do = new FWDR3DCovDisplayObject("div");
            ...
            this.normalMenu_do.setInnerHTML("&#0169; LawPavilion");
            this.normalMenu_do.setBkColor("#FFFFFF");
            this.selectedMenu_do = new FWDR3DCovDisplayObject("div");
            ...
            this.selectedMenu_do.setInnerHTML("&#0169; LawPavilion");
            this.selectedMenu_do.setBkColor("#000000");
            this.selectedMenu_do.setAlpha(0);
            this.over_do = new FWDR3DCovDisplayObject("div");
        ...
        this.mouseOverHandler = function() {
            ...
            FWDR3DCovModTweenMax.to(n.normalMenu_do, .8, {alpha: 0,ease: Expo.easeOut});
            FWDR3DCovModTweenMax.to(n.selectedMenu_do, .8, {alpha: 1,ease: Expo.easeOut})
        };
        this.mouseOutHandler = function() {
            FWDR3DCovModTweenMax.to(n.normalMenu_do, .8, {alpha: 1,ease: Expo.easeOut});
            FWDR3DCovModTweenMax.to(n.selectedMenu_do, .8, {alpha: 0,ease: Expo.easeOut})
        };
        ...
        this.destroy = function() {
            ...
            if (this.menu_do) {
                FWDR3DCovModTweenMax.killTweensOf(n.normalMenu_do);
                FWDR3DCovModTweenMax.killTweensOf(n.selectedMenu_do);
...
(function(e) {
    var t = function(e) {
        ...
        this.parseProperties = function() {
            ...
            if (!n.propsObj.coverflowDataListDivId) {
                e = "Coverflow data list id is not defined in FWDR3DCov3DCoverflow constructor function!";
                n.dispatchEvent(t.LOAD_ERROR, {text: e});
                return
            }
            n.rootElement = FWDR3DCovUtils.getChildById(n.propsObj.coverflowDataListDivId);
            if (!n.rootElement) {
            ...
            n.showDisplay2DAlways = false;
            n.coverflowStartPosition = n.propsObj.coverflowStartPosition;
            n.swipeSpeed = n.propsObj.coverflowMobileSwipeSpeed || 1;
            ...
            if (n.propsObj.comboBoxPosition == "topleft" || n.propsObj.comboBoxPosition == "topright") {
                n.comboBoxPosition = FWDR3DCovUtils.trim(n.propsObj.comboBoxPosition).toLowerCase()
            } else {
            ...
            var r = FWDR3DCovUtils.getChildrenFromAttribute(n.rootElement, "data-cat");
            if (!r) {
                e = "At least one ul tag with the attribute <font color='#FFFFFF'>data-cat</font> must be defined in the playlist.";
                n.dispatchEvent(t.LOAD_ERROR, {text: e});
                return
            }
            var i = r.length;
            ...
            for (var y = 0; y < i; y++) {
                ...
                a = [];
                u = [];
                p = FWDR3DCovUtils.getChildren(l);
                c = p.length;
                for (var b = 0; b < c; b++) {
                    var w = {};
                    var E = p[b];
                    var f = FWDR3DCovUtils.getChildren(E);
                    m = y + 1;
                    g = b + 1;
                    h = f.length;
                    if (n.showThumbnailsHtmlContent) {
                        ...
                        for (var S = 0; S < h; S++) {
                            v = "data-html-content";
                            if (FWDR3DCovUtils.hasAttribute(f[S], "data-html-content")) {
                                x = false;
                        ...
                        for (var S = 0; S < h; S++) {
                            ...
                            if (FWDR3DCovUtils.hasAttribute(f[S], "data-thumbnail-path")) {
                                x = false;
                                w.thumbPath = FWDR3DCovUtils.trim(FWDR3DCovUtils.getAttributeValue(f[S], "data-thumbnail-path"));
                                break
                            }
                        }
                        if (x) {
                    ...
                    if (n.showText) {
                        ...
                        for (var S = 0; S < h; S++) {
                            ...
                            if (FWDR3DCovUtils.hasAttribute(f[S], "data-thumbnail-text")) {
                                x = false;
                        ...
                        w.textTitleOffset = parseInt(FWDR3DCovUtils.trim(FWDR3DCovUtils.getAttributeValue(d, "data-thumbnail-text-title-offset")));
                        w.textDescriptionOffsetTop = parseInt(FWDR3DCovUtils.trim(FWDR3DCovUtils.getAttributeValue(d, "data-thumbnail-text-offset-top")));
                        w.textDescriptionOffsetBottom = parseInt(FWDR3DCovUtils.trim(FWDR3DCovUtils.getAttributeValue(d, "data-thumbnail-text-offset-bottom")));
                        if (FWDR3DCovUtils.trim(w.thumbText) == "") {
                            w.emptyText = true
                        } else {
                            w.emptyText = false
                        }
                    ...
                    for (var S = 0; S < h; S++) {
                        v = "data-type";
                        if (FWDR3DCovUtils.hasAttribute(f[S], "data-type")) {
                            x = false;
                            w.mediaType = FWDR3DCovUtils.trim(FWDR3DCovUtils.getAttributeValue(f[S], "data-type"));
                            break
                        }
                    }
                    if (x) {
                    ...
                    if (w.mediaType != "none") {
                        ...
                        for (var S = 0; S < h; S++) {
                            v = "data-url";
                            if (FWDR3DCovUtils.hasAttribute(f[S], "data-url")) {
                                x = false;
                                d = f[S];
                                break
                            }
                    ...
                    d = f[S];
                    var T = {};
                    T.dataType = FWDR3DCovUtils.trim(FWDR3DCovUtils.getAttributeValue(d, "data-type"));
                    T.url = FWDR3DCovUtils.trim(FWDR3DCovUtils.getAttributeValue(d, "data-url"));
                    T.target = FWDR3DCovUtils.getAttributeValue(d, "data-target");
                    T.info = FWDR3DCovUtils.getAttributeValue(d, "data-info");
                    if (!T.target)
                        T.target = "_blank";
                    for (var S = 0; S < h; S++) {
                        if (FWDR3DCovUtils.hasAttribute(f[S], "data-info")) {
                ...
                n.categoriesAr[y] = FWDR3DCovUtils.getAttributeValue(l, "data-cat") || "not defined!";
                n.dataListAr[y] = a;
                n.lightboxAr[y] = u
            }
            ...
            if (!n.propsObj.skinPath) {
                n.dispatchEvent(t.LOAD_ERROR, {text: "Coverflow graphics skin path is not defined in FWDR3DCov3DCoverflow constructor function!"});
                return
            }
        ...
        this.checkForAttribute = function(e, r) {
            var i = FWDR3DCovUtils.getChildFromNodeListFromAttribute(e, r);
            i = i ? FWDR3DCovUtils.trim(FWDR3DCovUtils.getAttributeValue(i, r)) : undefined;
            if (!i) {
                n.dispatchEvent(t.LOAD_ERROR, {text: "Element  with attribute <font color='#FFFFFF'>" + r + "</font> is not defined."});
                return
            }
            return i
        };
        this.destroy = function() {
            ...
            if (this.thumbGradientLeftImg)
                this.thumbGradientLeftImg.src = "";
            if (this.thumbGradientRightImg)
                this.thumbGradientRightImg.src = "";
            ...
            if (this.comboboxArrowIconN_img)
                this.comboboxArrowIconN_img.src = "";
            if (this.comboboxArrowIconS_img)
                this.comboboxArrowIconS_img.src = "";
    ...
    t.setPrototype = function() {
        t.prototype = new FWDR3DCovEventDispatcher
    };
    t.prototype = null;
...
(function(e) {
    var t = function(e, t, n, r) {
        ...
        this.isMobile_bl = FWDR3DCovUtils.isMobile;
        this.hasTransform3d_bl = FWDR3DCovUtils.hasTransform3d;
        this.hasTransform2d_bl = FWDR3DCovUtils.hasTransform2d;
        if (FWDR3DCovUtils.isFirefox)
        ...
        this.setY = function(e) {
            ...
            if (i.isMobile_bl) {
                i.screen.style[i.transform] = "translate(" + i.x + "px," + i.y + "px)"
            } else if (i.hasTransform3d_bl && !FWDR3DCovUtils.isAndroid) {
                i.screen.style[i.transform] = "translate3d(" + i.x + "px," + i.y + "px,0)"
            } else if (i.hasTransform2d_bl) {
                i.screen.style[i.transform] = "translate(" + i.x + "px," + i.y + "px)"
            } else {
        ...
        this.addChild = function(e) {
            if (this.contains(e)) {
                this.children_ar.splice(FWDR3DCovUtils.indexOfArray(this.children_ar, e), 1);
        ...
        this.contains = function(e) {
            if (FWDR3DCovUtils.indexOfArray(this.children_ar, e) == -1) {
                return false
            } else {
                return true
            }
...
(function() {
    ...
    window.FWDR3DCovEventDispatcher = e
})(window);
(function(e) {
    var t = function() {
        var e = this;
    ...
    t.setPrototype = function() {
        t.prototype = new FWDR3DCovDisplayObject("div", "relative")
    };
    t.prototype = null;
    e.FWDR3DCovInfo = t
})(window);
(function(e) {
    var t = function(n, r, i, s, o) {
        ...
        this.setupMainContainers = function() {
            this.main_do = new FWDR3DCovDisplayObject("div");
            this.text_do = new FWDR3DCovDisplayObject("div");
            ...
            this.background_do = new FWDR3DCovDisplayObject("div");
        ...
        this.resize = function(e, t, n) {
            ...
            FWDR3DCovModTweenMax.killTweensOf(u.obj);
            if (n) {
                FWDR3DCovModTweenMax.to(u.obj, .8, {delay: .1,currentWidth: u.maxWidth,onUpdate: u.onTweenUpdate,ease: Expo.easeInOut})
            } else {
        ...
        this.hide = function(e) {
            FWDR3DCovModTweenMax.killTweensOf(this);
            if (e) {
                FWDR3DCovModTweenMax.to(this, .6, {y: -this.finalHeight,ease: Expo.easeInOut,onComplete: this.hideComplete});
        ...
        this.show = function(e) {
            ...
            FWDR3DCovModTweenMax.killTweensOf(this);
            if (e) {
                FWDR3DCovModTweenMax.to(this, .6, {y: this.margins,ease: Expo.easeInOut})
            } else {
                this.setVisible(false);
                this.setY(this.margins)
            }
        ...
        this.destroy = function() {
            ...
            FWDR3DCovModTweenMax.killTweensOf(this);
            FWDR3DCovModTweenMax.killTweensOf(this.obj);
...
(function(e) {
    var t = function(n) {
        ...
        r.onScrollHandler = function(e) {
            if (!r.orintationChanceComplete_bl)
                return;
            var t = FWDR3DCovUtils.getScrollOffsets();
            r.setX(t.x);
            r.setY(t.y)
        };
        ...
        this.resizeHandler = function() {
            if (!r.orintationChanceComplete_bl)
                return;
            var e = FWDR3DCovUtils.getViewportSize();
            var t = FWDR3DCovUtils.getScrollOffsets();
        ...
        this.setupContextMenu = function() {
            this.customContextMenu = new FWDR3DCovContextMenu(this, this.showContextMenu_bl)
        };
        ...
        this.show = function(e) {
            ...
            FWDR3DCovModTweenMax.to(this.bk_do, .8, {alpha: this.backgroundOpacity,ease: Quint.easeOut,onComplete: this.onShowComplete});
        ...
        this.showCurrentItem = function() {
            ...
            if (this.data_ar[this.id].dataType.toLowerCase() == "iframe") {
                ...
                args = FWDR3DCovUtils.getUrlArgs(this.type_str);
                if (!args.v) {
                    this.addChild(this.info_do);
                ...
                if (this.firstTimeShowed_bl) {
                    ...
                    if (this.prevItem_do) {
                        if (this.opacityType == "filter" && this.prevItem_do.type != "img") {
                            ...
                            FWDR3DCovModTweenMax.to(this.prevItem_do, .8, {alpha: 0})
                        }
                    }
                    this.createIframeHolder();
                    ...
                    if (this.showZoomButton_bl && (this.type_str == t.YOUTUBE || this.type_str == t.VIMEO || r.type_str == t.IFRAME)) {
                        var e = FWDR3DCovUtils.indexOfArray(this.buttons_ar, this.zoomButton_do);
                        if (e != -1) {
        ...
        this.createIframeHolder = function() {
            this.currentItem_do = new FWDR3DCovDisplayObject("div");
        ...
        this.imageLoadComplete = function(e) {
            if (r.prevItem_do) {
                if (!r.isMobile_bl && r.prevItem_do.type == "img")
                    FWDR3DCovModTweenMax.to(r.prevItem_do, .6, {alpha: 0})
            }
            r.originalWidth = r.image_img.width;
            r.originalHeight = r.image_img.height;
            r.currentItem_do = new FWDR3DCovDisplayObject("img");
            ...
            if (r.firstTimeShowed_bl) {
                ...
                FWDR3DCovModTweenMax.to(r.currentItem_do, .6, {alpha: 1,delay: .8});
        ...
        this.animMainDos = function() {
            FWDR3DCovModTweenMax.to(this.mainItemsHolder_do, .8, {delay: .1,x: r.finalX,y: r.finalY,w: r.finalWidth,h: r.finalHeight,ease: Expo.easeInOut});
            FWDR3DCovModTweenMax.to(this.itemsBackground_do, .8, {delay: .1,x: r.borderSize,y: r.borderSize,w: r.finalWidth - r.borderSize * 2,h: r.finalHeight - r.borderSize * 2,ease: Expo.easeInOut});
            FWDR3DCovModTweenMax.to(this.itemsBorder_do, .8, {delay: .1,w: r.finalWidth,h: r.finalHeight,ease: Expo.easeInOut});
            FWDR3DCovModTweenMax.to(this.itemsHolder_do, .8, {delay: .1,x: r.borderSize,y: r.borderSize,w: r.finalWidth - r.borderSize * 2,h: r.finalHeight - r.borderSize * 2,ease: Expo.easeInOut});
            if (!this.isMobile_bl && this.prevItem_do.type == "img")
                FWDR3DCovModTweenMax.to(r.prevItem_do, .8, {delay: .1,x: (r.finalWidth - r.borderSize * 2 - r.prevItem_do.getWidth()) / 2,y: (r.finalHeight - r.borderSize * 2 - r.prevItem_do.getHeight()) / 2,ease: Expo.easeInOut})
        };
        ...
        this.showItemFirstTime = function() {
            ...
            FWDR3DCovModTweenMax.to(this.currentItem_do, .8, {alpha: 1,delay: .9,ease: Quint.easeOut});
            FWDR3DCovModTweenMax.to(this.itemsBorder_do, .8, {alpha: 1,delay: .7,ease: Quint.easeOut});
            FWDR3DCovModTweenMax.to(this.mainItemsHolder_do, .8, {x: this.finalX,y: this.finalY,w: this.finalWidth,h: this.finalHeight,ease: Expo.easeInOut});
            if (this.showZoomButton_bl && (this.type_str == t.YOUTUBE || this.type_str == t.VIMEO || r.type_str == t.IFRAME)) {
                var e = FWDR3DCovUtils.indexOfArray(this.buttons_ar, this.zoomButton_do);
                if (e != -1) {
                    this.buttons_ar.splice(e, 1);
        ...
        this.cleanChildren = function(e) {
            ...
            while (r.itemsHolder_do.getNumChildren() > e) {
                ...
                FWDR3DCovModTweenMax.killTweensOf(t);
        ...
        this.resizeCurrentItem = function(e) {
            ...
            if (e)
                return;
            FWDR3DCovModTweenMax.killTweensOf(this.mainItemsHolder_do);
            ...
            FWDR3DCovModTweenMax.killTweensOf(this.itemsBackground_do);
            ...
            FWDR3DCovModTweenMax.killTweensOf(this.itemsBorder_do);
            ...
            FWDR3DCovModTweenMax.killTweensOf(this.currentItem_do);
        ...
        this.maximizeOrMinimize = function() {
            ...
            if (this.isMaximized_bl) {
                ...
                FWDR3DCovModTweenMax.to(this.currentItem_do, .8, {x: 0,y: 0,w: this.finalWidth - this.borderSize * 2,h: this.finalHeight - this.borderSize * 2,ease: Expo.easeInOut});
                ...
                if (this.isMobile_bl) {
                    FWDR3DCovModTweenMax.to(this.zoomButton_do, .8, {x: this.stageWidth - this.buttonWidth,y: 1,ease: Expo.easeInOut});
                    FWDR3DCovModTweenMax.to(this.currentItem_do, .8, {x: i,y: s,w: o,h: u,ease: Expo.easeInOut})
                } else {
                    this.zoomButton_do.isMaximized_bl = true;
                    if (e >= n) {
                        FWDR3DCovModTweenMax.to(this.currentItem_do, .8, {x: i,w: o,h: u,ease: Expo.easeInOut})
                    } else if (e < n) {
                        FWDR3DCovModTweenMax.to(this.currentItem_do, .8, {y: s,w: o,h: u,ease: Expo.easeInOut})
                    }
        ...
        this.updateMaximizeImageOnMouseMovedHandler = function(e) {
            var t = FWDR3DCovUtils.getViewportMouseCoordinates(e);
            var n = FWDR3DCovUtils.getScrollOffsets();
            r.globalXMousePosition = t.screenX;
            r.globalYMousePosition = t.screenY;
            FWDR3DCovModTweenMax.to(r.zoomButton_do, .2, {x: r.globalXMousePosition - parseInt(r.buttonWidth / 2),y: r.globalYMousePosition - parseInt(r.buttonHeight / 2)})
        };
        this.updateMaximizedImageHandler = function() {
            ...
            if (n <= i) {
                ...
                if (isNaN(e))
                    return;
                FWDR3DCovModTweenMax.to(r.currentItem_do, .4, {x: e})
            } else {
                t = Math.round((r.stageHeight - r.currentItem_do.getHeight()) * r.percentY);
                if (isNaN(t))
                    return;
                FWDR3DCovModTweenMax.to(r.currentItem_do, .4, {y: t})
            }
        };
        ...
        this.setupCloseButton = function() {
            ...
            this.closeButton_do = new FWDR3DCovSimpleButton(this.closeN_img, this.closeS_img, this.isMobile_bl);
            this.closeButton_do.addListener(FWDR3DCovSimpleButton.CLICK, this.closeButtonOnClickHandler);
        ...
        this.setupNextAndPrevButtons = function() {
            FWDR3DCovSimpleButton.setPrototype();
            this.nextButton_do = new FWDR3DCovSimpleButton(this.nextN_img, this.nextS_img, this.isMobile_bl);
            this.nextButton_do.addListener(FWDR3DCovSimpleButton.CLICK, this.nextButtonOnClickHandler);
            FWDR3DCovSimpleButton.setPrototype();
            this.prevButton_do = new FWDR3DCovSimpleButton(this.prevN_img, this.prevS_img, this.isMobile_bl);
            this.prevButton_do.addListener(FWDR3DCovSimpleButton.CLICK, this.prevButtonOnClickHandler);
        ...
        this.setupZoomButton = function() {
            FWDR3DCovComplexButton.setPrototype();
            this.zoomButton_do = new FWDR3DCovComplexButton(this.minimizeN_img, this.minimizeS_img, this.maximizeN_img, this.maximizeS_img, this.isMobile_bl, true);
            this.zoomButton_do.addListener(FWDR3DCovComplexButton.CLICK, this.onZoomButtonClickHandler);
            this.addChild(this.zoomButton_do)
        };
        ...
        this.setupInfoButton = function() {
            FWDR3DCovComplexButton.setPrototype();
            this.infoButton_do = new FWDR3DCovComplexButton(this.infoCloseN_img, this.infoCloseS_img, this.infoOpenN_img, this.infoOpenS_img, this.isMobile_bl, false);
            this.infoButton_do.addListener(FWDR3DCovComplexButton.FIRST_BUTTON_CLICK, this.onHideInfoButtonPressedHandler);
            this.infoButton_do.addListener(FWDR3DCovComplexButton.SECOND_BUTTON_CLICK, this.onShowInfoButtonPressedHandler);
        ...
        this.setupInfoWindow = function() {
            FWDR3DCovInfoWindow.setPrototype();
            this.infoWindow_do = new FWDR3DCovInfoWindow(this.borderSize, this.infoWindowBackgroundColor, this.infoWindowBackgroundOpacity, this.borderRadius, this.isMobile_bl)
        };
        this.setupSlideshowButton = function() {
            FWDR3DCovComplexButton.setPrototype();
            this.slideshowButtton_do = new FWDR3DCovComplexButton(this.pauseN_img, this.pauseS_img, this.playN_img, this.playS_img, this.isMobile_bl, false);
            this.slideshowButtton_do.addListener(FWDR3DCovComplexButton.FIRST_BUTTON_CLICK, this.onStopSlideShowHandler);
            this.slideshowButtton_do.addListener(FWDR3DCovComplexButton.SECOND_BUTTON_CLICK, this.onStartSlideShowHandler);
        ...
        this.setupTimerManager = function() {
            FWDR3DCovTimerManager.setProtptype();
            this.timerManager = new FWDR3DCovTimerManager(this.slideShowDelay, this.slideShowAutoPlay_bl);
            this.timerManager.addListener(FWDR3DCovTimerManager.START, this.onTimerManagerStartHandler);
            this.timerManager.addListener(FWDR3DCovTimerManager.STOP, this.onTimerManagerStopHandler);
            this.timerManager.addListener(FWDR3DCovTimerManager.TIME, this.onTimerManagerTimeHandler)
        };
        ...
        this.setupSlideShowPreloader = function() {
            FWDR3DCovSlideShowPreloader.setPrototype();
            this.slideShowPreloader_do = new FWDR3DCovSlideShowPreloader(this.slideShowPreloader_img, 31, this.slideshowPreloaderHeight, 11, this.slideShowDelay);
        ...
        this.positionSlideShowPreloader = function(e) {
            ...
            if (e) {
                FWDR3DCovModTweenMax.to(this.slideShowPreloader_do, .8, {x: this.slideShowPreloader_do.finalX,y: this.slideShowPreloader_do.finalY,delay: .1,ease: Expo.easeInOut})
            } else {
        ...
        this.positionButtons = function(e) {
            ...
            for (var u = 0; u < n; u++) {
                ...
                if (t) {
                    if (e) {
                        FWDR3DCovModTweenMax.to(t, .8, {x: t.finalX,y: t.finalY,delay: .1,ease: Expo.easeInOut})
                    } else {
                        t.setX(t.finalX);
                        t.setY(t.finalY)
                    }
            ...
            if (this.showNextAndPrevButtons_bl) {
                FWDR3DCovModTweenMax.killTweensOf(this.prevButton_do);
                if (e) {
                    FWDR3DCovModTweenMax.to(this.prevButton_do, .8, {x: this.finalX - this.buttonWidth,y: Math.round((this.stageHeight - this.buttonHeight) / 2),delay: .1,ease: Expo.easeInOut})
                } else {
            ...
            if (this.isMaximized_bl && this.zoomButton_do && this.isMobile_bl) {
                FWDR3DCovModTweenMax.killTweensOf(this.zoomButton_do);
        ...
        this.setupPreloader = function() {
            ...
            this.preloader_do = new FWDR3DCovPreloader(this.preloaderImg, 85, 36, 20, 50);
            this.preloader_do.addListener(FWDR3DCovPreloader.HIDE_COMPLETE, this.onPreloaderHideCompleteHandler)
        };
        ...
        this.hide = function() {
            ...
            if (this.type_str == t.YOUTUBE || this.type_str == t.VIMEO || r.type_str == t.IFRAME) {
                ...
                FWDR3DCovModTweenMax.to(this.itemsBorder_do, .9, {alpha: 0,ease: Quint.easeOut});
                FWDR3DCovModTweenMax.to(this.mainItemsHolder_do, .9, {x: this.stageWidth / 2,y: this.stageHeight / 2,w: 0,h: 0,ease: Expo.easeInOut});
                FWDR3DCovModTweenMax.to(this.bk_do, .9, {alpha: 0,delay: .9,ease: Quint.easeOut,onComplete: this.onHideComplete})
            } else if (this.type_str == t.IMAGE) {
                if (this.currentItem_do && this.currentItem_do.screen) {
                    FWDR3DCovModTweenMax.killTweensOf(this.currentItem_do);
                    FWDR3DCovModTweenMax.to(this.currentItem_do, .7, {alpha: 0,ease: Quint.easeOut})
                }
                FWDR3DCovModTweenMax.to(this.itemsBorder_do, .9, {alpha: 0,delay: .1,ease: Quint.easeOut});
                FWDR3DCovModTweenMax.to(this.mainItemsHolder_do, .9, {x: this.stageWidth / 2,y: this.stageHeight / 2,w: 0,h: 0,delay: .2,ease: Expo.easeInOut});
                FWDR3DCovModTweenMax.to(this.bk_do, .9, {alpha: 0,delay: 1.2,ease: Quint.easeOut,onComplete: this.onHideComplete})
            }
            this.preloader_do.hide(true);
        ...
        this.hideButtons = function(e) {
            if (e) {
                FWDR3DCovModTweenMax.to(this.closeButton_do, .8, {x: this.stageWidth,ease: Expo.easeInOut});
                if (this.infoButton_do)
                    FWDR3DCovModTweenMax.to(this.infoButton_do, .8, {x: this.stageWidth,ease: Expo.easeInOut});
                if (this.slideshowButtton_do)
                    FWDR3DCovModTweenMax.to(this.slideshowButtton_do, .8, {x: this.stageWidth,ease: Expo.easeInOut});
                if (this.zoomButton_do)
                    FWDR3DCovModTweenMax.to(this.zoomButton_do, .8, {x: this.stageWidth,ease: Expo.easeInOut});
                if (this.nextButton_do) {
                    FWDR3DCovModTweenMax.to(this.nextButton_do, .8, {x: this.stageWidth,ease: Expo.easeInOut});
                    FWDR3DCovModTweenMax.to(this.prevButton_do, .8, {x: -this.buttonWidth,ease: Expo.easeInOut})
                }
                if (this.slideShowPreloader_do)
                    FWDR3DCovModTweenMax.to(this.slideShowPreloader_do, .8, {x: this.stageWidth,ease: Expo.easeInOut})
            } else {
        ...
        this.destroy = function() {
            ...
            this.cleanChildren(0);
            if (this.nextButton_do) {
                FWDR3DCovModTweenMax.killTweensOf(this.nextButton_do);
                FWDR3DCovModTweenMax.killTweensOf(this.prevButton_do);
                this.nextButton_do.destroy();
                this.prevButton_do.destroy()
            }
            if (this.closeButton_do) {
                FWDR3DCovModTweenMax.killTweensOf(this.closeButton_do);
            ...
            if (this.infoButton_do) {
                FWDR3DCovModTweenMax.killTweensOf(this.infoButton_do);
                this.infoButton_do.destroy()
            }
            if (this.slideshowButtton_do) {
                FWDR3DCovModTweenMax.killTweensOf(this.slideshowButtton_do);
            ...
            FWDR3DCovModTweenMax.killTweensOf(this.mainItemsHolder_do);
            FWDR3DCovModTweenMax.killTweensOf(this.bk_do);
            FWDR3DCovModTweenMax.killTweensOf(this.itemsBackground_do);
            FWDR3DCovModTweenMax.killTweensOf(this.itemsBorder_do);
            FWDR3DCovModTweenMax.killTweensOf(this.itemsHolder_do);
    ...
    t.prototype = null;
    e.FWDR3DCovLightBox = t
})(window);
(window._gsQueue || (window._gsQueue = [])).push(function() {
    "use strict";
    window._gsDefine("FWDR3DCovModTweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(e, t, n) {
        ...
        i.delayedCall = function(e, t, n, r, s) {
            return new i(t, 0, {delay: e,onComplete: t,onCompleteParams: n,onCompleteScope: r,onReverseComplete: t,onReverseCompleteParams: n,onReverseCompleteScope: r,immediateRender: false,useFrames: s,overwrite: 0})
        };
        i.set = function(e, t) {
            return new i(e, 0, t)
        };
    ...
    (function() {
        ...
        }, v = window._gsDefine.plugin({propName: "bezier",priority: -1,API: 2,global: true,init: function(e, t, n) {
            this._target = e;
        ...
        v._cssRegister = function() {
            ...
            n._registerComplexSpecialProp("bezier", {parser: function(e, n, o, u, a, f) {
    ...
    window._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(e, t) {
        ...
        a = "px";
        n.suffixMap = {top: a,right: a,bottom: a,left: a,width: a,height: a,fontSize: a,padding: a,margin: a,perspective: a};
        ...
        var gt = function(e, t) {
            ...
            if (!u[e]) {
                ...
                yt(e, {parser: function(e, n, r, i, s, o, a) {
        ...
        n.registerSpecialProp = function(e, t, n) {
            yt(e, {parser: function(e, r, i, s, o, u, a) {
        ...
        yt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation", {parser: function(e, t, n, r, i, o, u) {
            if (r._transform) {
                return i
            }
            ...
            if (typeof h.transform === "string" && Et) {
                ...
                d = {scaleX: rt(h.scaleX != null ? h.scaleX : h.scale, a.scaleX),scaleY: rt(h.scaleY != null ? h.scaleY : h.scale, a.scaleY),scaleZ: rt(h.scaleZ != null ? h.scaleZ : h.scale, a.scaleZ),x: rt(h.x, a.x),y: rt(h.y, a.y),z: rt(h.z, a.z),perspective: rt(h.transformPerspective, a.perspective)};
        ...
        yt("boxShadow", {defaultValue: "0px 0px 0px 0px #999",prefix: true,color: true,multi: true,keyword: "inset"});
        yt("borderRadius", {defaultValue: "0px",parser: function(e, t, n, r, o, u) {
            t = this.format(t);
        ...
        yt("backgroundPosition", {defaultValue: "0 0",parser: function(e, t, n, r, i, o) {
        ...
        yt("clip", {defaultValue: "rect(0px,0px,0px,0px)",parser: function(e, t, n, r, i, o) {
            var u, a, f;
            if (I < 9) {
                a = e.currentStyle;
                f = I < 8 ? " " : ",";
        ...
        yt("autoRound,strictUnits", {parser: function(e, t, n, r, i) {
            return i
        }});
        yt("border", {defaultValue: "0px solid #000",parser: function(e, t, n, r, i, o) {
        ...
        yt("float,cssFloat,styleFloat", {parser: function(e, t, n, r, i, s) {
        ...
        yt("opacity,alpha,autoAlpha", {defaultValue: "1",parser: function(e, t, n, r, i, o) {
        ...
        yt("className", {parser: function(e, t, n, i, o, u, a) {
        ...
        yt("clearProps", {parser: function(e, t, n, i, s) {
    ...
    (function() {
        var e = window._gsDefine.plugin({propName: "roundProps",priority: -1,API: 2,init: function(e, t, n) {
            this._tween = n;
            return true
        }}), t = e.prototype;
    ...
    window._gsDefine.plugin({propName: "attr",API: 2,init: function(e, t, n) {
        var r;
    ...
    window._gsDefine.plugin({propName: "directionalRotation",API: 2,init: function(e, t, n) {
        if (typeof t !== "object") {
            t = {rotation: t}
        }
        this.finals = {};
    ...
    window._gsDefine("easing.Back", ["easing.Ease"], function(e) {
        ...
        s("easing.EaseLookup", {find: function(t) {
            return e.map[t]
        }}, true);
...
(function(e) {
    ...
    a._initProps = function(e, t, n, r) {
        ...
        for (i in this.vars) {
            if (D[i]) {
                ...
                this._firstPT = f = {_next: this._firstPT,t: u,p: "setRatio",s: 0,c: 1,f: true,n: i,pg: true,pr: u._priority};
                ...
                this._firstPT = t[i] = f = {_next: this._firstPT,t: e,p: i,f: typeof e[i] === "function",n: i,pg: false,pr: 0};
    ...
    C.delayedCall = function(e, t, n, r, i) {
        return new C(t, 0, {delay: e,onComplete: t,onCompleteParams: n,onCompleteScope: r,onReverseComplete: t,onReverseCompleteParams: n,onReverseCompleteScope: r,immediateRender: false,useFrames: i,overwrite: 0})
    };
    C.set = function(e, t) {
        return new C(e, 0, t)
    };
    ...
    a._addTween = function(e, t, n, r, i, s) {
        ...
        if (r != null && (o = typeof r === "number" || r.charAt(1) !== "=" ? Number(r) - n : parseInt(r.charAt(0) + "1", 10) * Number(r.substr(2)))) {
            this._firstPT = u = {_next: this._firstPT,t: e,p: t,s: n,c: o,f: typeof e[t] === "function",n: i || t,r: s};
            if (u._next) {
                u._next._prev = u
            }
        }
    ...
    p.plugin = function(e) {
        ...
        var t = e.propName, n = e.priority || 0, r = e.overwriteProps, i = {init: "_onInitTween",set: "setRatio",kill: "_kill",round: "_roundProps",initAll: "_onInitAllProps"}, s = d("plugins." + t.charAt(0).toUpperCase() + t.substr(1) + "Plugin", function() {
            q.call(this, t, n);
...
(function(e) {
    var t = function(e, n, r, i, s) {
        ...
        this.show = function() {
            o.setVisible(true);
            o.start();
            FWDR3DCovModTweenMax.killTweensOf(o);
            o.setAlpha(0);
            FWDR3DCovModTweenMax.to(o, 1, {alpha: 1});
            o.isShowed_bl = true
        };
        this.hide = function(e) {
            if (!o.isShowed_bl)
            ...
            FWDR3DCovModTweenMax.killTweensOf(o);
            if (e) {
                FWDR3DCovModTweenMax.to(o, 1, {alpha: 0,onComplete: o.onHideComplete})
            } else {
                o.setVisible(false);
                o.setAlpha(0);
                o.stop()
...
(function(e) {
    var t = function(n, r, i) {
        ...
        this.setTrack = function() {
            ...
            s.scrollbarTrackRightDO = new FWDR3DCovSimpleDisplayObject("img");
        ...
        this.setHandler = function() {
            s.scrollbarHandlerDO = new FWDR3DCovDisplayObject("div");
            ...
            s.scrollbarHandlerCenterNDO = new FWDR3DCovSimpleDisplayObject("div");
            ...
            s.scrollbarHandlerRightSDO = new FWDR3DCovSimpleDisplayObject("img");
            ...
            s.scrollbarHandlerRightNDO = new FWDR3DCovSimpleDisplayObject("img");
            ...
            s.scrollbarHandlerTextDO = new FWDR3DCovDisplayObject("div");
            ...
            s.scrollbarHandlerOverDO = new FWDR3DCovDisplayObject("div");
        ...
        this.onScrollMouseOver = function() {
            ...
            FWDR3DCovModTweenMax.to(s.scrollbarHandlerLeftNDO, .8, {alpha: 0,ease: Expo.easeOut});
            FWDR3DCovModTweenMax.to(s.scrollbarHandlerCenterNDO, .8, {alpha: 0,ease: Expo.easeOut});
            FWDR3DCovModTweenMax.to(s.scrollbarHandlerRightNDO, .8, {alpha: 0,ease: Expo.easeOut});
            FWDR3DCovModTweenMax.to(s.scrollbarHandlerTextDO.screen, .8, {css: {color: s.textColorSelected},ease: Expo.easeOut})
        };
        this.onScrollMouseOut = function() {
            s.scrollbarOver = false;
            if (s.isPressed)
                return;
            FWDR3DCovModTweenMax.to(s.scrollbarHandlerLeftNDO, .8, {alpha: 1,ease: Expo.easeOut});
            FWDR3DCovModTweenMax.to(s.scrollbarHandlerCenterNDO, .8, {alpha: 1,ease: Expo.easeOut});
            FWDR3DCovModTweenMax.to(s.scrollbarHandlerRightNDO, .8, {alpha: 1,ease: Expo.easeOut});
            FWDR3DCovModTweenMax.to(s.scrollbarHandlerTextDO.screen, .8, {css: {color: s.textColorNormal},ease: Expo.easeOut})
        };
        this.onScrollMouseDown = function(t) {
            ...
            s.isPressed = true;
            FWDR3DCovModTweenMax.killTweensOf(s.scrollbarHandlerDO);
            if (s.isMobile) {
                if (s.hasPointerEvent) {
        ...
        this.onScrollMove = function(e) {
            var n = FWDR3DCovUtils.getViewportMouseCoordinates(e);
            s.mouseX = n.screenX;
            s.mouseY = n.screenY;
            ...
            if (s.prevCurItemId != s.curItemId) {
                s.dispatchEvent(t.MOVE, {id: s.curItemId});
                s.scrollbarHandlerTextDO.setInnerHTML(s.curItemId + 1 + "/" + s.totalItems)
            }
        ...
        this.gotoItem = function(e, t) {
            ...
            if (s.prevCurItemId != s.curItemId) {
                if (t) {
                    FWDR3DCovModTweenMax.killTweensOf(s.scrollbarHandlerDO);
                    FWDR3DCovModTweenMax.to(s.scrollbarHandlerDO, .8, {x: Math.floor(s.curItemId * (s.trackWidth - s.handlerWidth) / (s.totalItems - 1)),ease: Expo.easeOut})
                } else {
                    s.scrollbarHandlerDO.setX(Math.floor(s.curItemId * (s.trackWidth - s.handlerWidth) / (s.totalItems - 1)))
                }
                s.scrollbarHandlerTextDO.setInnerHTML(s.curItemId + 1 + "/" + s.totalItems)
        ...
        this.destroy = function() {
            ...
            FWDR3DCovModTweenMax.killTweensOf(s.scrollbarHandlerLeftNDO);
            FWDR3DCovModTweenMax.killTweensOf(s.scrollbarHandlerCenterNDO);
            FWDR3DCovModTweenMax.killTweensOf(s.scrollbarHandlerRightNDO);
            FWDR3DCovModTweenMax.killTweensOf(s.scrollbarHandlerDO);
            FWDR3DCovModTweenMax.killTweensOf(s.scrollbarHandlerTextDO.screen);
...
(function(e) {
    var t = function(e, n) {
        ...
        this.onMouseOver = function(e) {
            if (!e.pointerType || e.pointerType == e.MSPOINTER_TYPE_MOUSE) {
                FWDR3DCovModTweenMax.to(r.n_do, .9, {alpha: 0,ease: Expo.easeOut})
            }
        };
        this.onMouseOut = function(e) {
            if (!e.pointerType || e.pointerType == e.MSPOINTER_TYPE_MOUSE) {
                FWDR3DCovModTweenMax.to(r.n_do, .9, {alpha: 1,ease: Expo.easeOu})
            }
        };
        this.onClick = function(e) {
        ...
        this.destroy = function() {
            ...
            FWDR3DCovModTweenMax.killTweensOf(r.n_do);
            r.n_do.destroy();
            r.s_do.destroy();
            r.nImg = null;
            r.sImg = null;
...
(function(e) {
    ...
    e.FWDR3DCovSimpleDisplayObject = t
})(window);
(function(e) {
    var t = function(n) {
        var r = this;
        ...
        this.setPauseButton = function() {
            r.pauseButtonDO = new FWDR3DCovSimpleDisplayObject("img");
        ...
        this.setPlayButton = function() {
            r.playButtonDO = new FWDR3DCovDisplayObject("div");
            r.addChild(r.playButtonDO);
            r.playButtonSDO = new FWDR3DCovSimpleDisplayObject("img");
            r.playButtonSDO.setScreen(r.playButtonSImg);
            r.playButtonDO.addChild(r.playButtonSDO);
            r.playButtonNDO = new FWDR3DCovSimpleDisplayObject("img");
        ...
        this.onMouseOver = function() {
            if (r.isPlaying) {
                FWDR3DCovModTweenMax.to(r.timerButtonDO, .8, {alpha: 0,ease: Expo.easeOut})
            } else {
                FWDR3DCovModTweenMax.to(r.playButtonNDO, .8, {alpha: 0,ease: Expo.easeOut})
            }
        };
        this.onMouseOut = function() {
            if (r.isPlaying) {
                FWDR3DCovModTweenMax.to(r.timerButtonDO, .8, {alpha: 1,ease: Expo.easeOut})
            } else {
                FWDR3DCovModTweenMax.to(r.playButtonNDO, .8, {alpha: 1,ease: Expo.easeOut})
            }
        };
        this.onClick = function(e) {
            if (r.isPlaying) {
        ...
        this.destroy = function() {
            ...
            FWDR3DCovModTweenMax.killTweensOf(r.timerButtonDO);
            FWDR3DCovModTweenMax.killTweensOf(r.playButtonNDO);
...
(function(e) {
    ...
    t.prototype = null;
    e.FWDR3DCovSlideShowPreloader = t
})(window);
(function(e) {
    var t = function(e, n, r) {
        ...
        this.setupScreen = function() {
            i.mainDO = new FWDR3DCovDisplayObject("div");
            i.addChild(i.mainDO);
            ...
            if (n.showThumbnailsHtmlContent || !n.transparentImages) {
                i.borderDO = new FWDR3DCovSimpleDisplayObject("div");
                i.bgDO = new FWDR3DCovSimpleDisplayObject("div");
            ...
            i.imageHolderDO = new FWDR3DCovDisplayObject("div");
            ...
            if (!i.isMobile && !FWDR3DCovUtils.isIEAndLessThen9 && n.showGradient) {
                i.setupGradient()
            }
            if (FWDR3DCovUtils.isAndroid) {
        ...
        this.addReflection = function() {
            if (!i.imageDO || i.isMobile || FWDR3DCovUtils.isIEAndLessThen9)
                return;
            var e = i.thumbWidth - i.borderSize * 2;
            var t = i.thumbHeight - i.borderSize * 2;
            i.reflCanvasDO = new FWDR3DCovSimpleDisplayObject("canvas");
        ...
        this.addImage = function(e) {
            i.imageDO = new FWDR3DCovSimpleDisplayObject("img");
        ...
        this.addHtmlContent = function() {
            i.htmlContentDO = new FWDR3DCovSimpleDisplayObject("div");
        ...
        this.setupGradient = function() {
            ...
            i.gradientRightDO = new FWDR3DCovSimpleDisplayObject("img");
        ...
        this.setGradient = function(e) {
            ...
            if (!i.isMobile && !FWDR3DCovUtils.isIEAndLessThen9 && n.showGradient) {
                switch (i.pos) {
                    case 0:
                        FWDR3DCovModTweenMax.to(i.gradientLeftDO, .8, {alpha: 0});
                        FWDR3DCovModTweenMax.to(i.gradientRightDO, .8, {alpha: 0,onComplete: i.setGradPos});
                        break;
                    case 1:
                        i.gradientDO.setY(0);
                        FWDR3DCovModTweenMax.to(i.gradientLeftDO, .8, {alpha: 0});
                        FWDR3DCovModTweenMax.to(i.gradientRightDO, .8, {alpha: 1});
                        break;
                    case -1:
                        i.gradientDO.setY(0);
                        FWDR3DCovModTweenMax.to(i.gradientLeftDO, .8, {alpha: 1});
                        FWDR3DCovModTweenMax.to(i.gradientRightDO, .8, {alpha: 0});
                        break
                }
            }
        };
        ...
        this.addText = function(e, t, n) {
            if (i.curDataListAr[i.id].emptyText)
                return;
            i.textHolderDO = e;
            i.textGradientDO = t;
            i.textDO = n;
        ...
        this.setTextHeight = function() {
            ...
            FWDR3DCovModTweenMax.to(i.textHolderDO, .8, {alpha: 1,ease: Expo.easeOut});
            i.hasText = true;
            i.checkThumbOver()
        };
        this.removeText = function() {
            if (i.textHolderDO) {
                FWDR3DCovModTweenMax.to(i.textHolderDO, .6, {alpha: 0,ease: Expo.easeOut,onComplete: i.removeTextFinish})
            }
        };
        this.removeTextFinish = function() {
            FWDR3DCovModTweenMax.killTweensOf(i.textHolderDO);
            FWDR3DCovModTweenMax.killTweensOf(i.textGradientDO);
            FWDR3DCovModTweenMax.killTweensOf(i.textDO);
        ...
        this.onThumbOverHandler = function() {
            if (!i.isOver) {
                i.isOver = true;
                FWDR3DCovModTweenMax.to(i.textGradientDO, .8, {y: i.thumbHeight - i.borderSize * 2 - i.textDescriptionOffsetTop - i.textHeight - i.textDescriptionOffsetBottom,ease: Expo.easeOut});
                FWDR3DCovModTweenMax.to(i.textDO, .8, {y: i.thumbHeight - i.borderSize * 2 - i.textHeight - i.textDescriptionOffsetBottom,ease: Expo.easeOut})
            }
        };
        this.onThumbOutHandler = function() {
            if (i.isOver) {
                i.isOver = false;
                FWDR3DCovModTweenMax.to(i.textGradientDO, .8, {y: i.thumbHeight - i.borderSize * 2 - i.textTitleOffset,ease: Expo.easeOut});
                FWDR3DCovModTweenMax.to(i.textDO, .8, {y: i.thumbHeight - i.borderSize * 2 - i.textTitleOffset + i.textDescriptionOffsetTop,ease: Expo.easeOut})
            }
        };
        this.showThumb3D = function() {
            ...
            FWDR3DCovModTweenMax.to(i.imageHolderDO, .8, {x: i.borderSize,y: i.borderSize,w: e,h: t,ease: Expo.easeInOut});
            if (n.showThumbnailsHtmlContent) {
                i.htmlContentDO.setWidth(e);
                i.htmlContentDO.setHeight(t);
                i.htmlContentDO.setX(-parseInt(e / 2));
                i.htmlContentDO.setY(-parseInt(t / 2));
                FWDR3DCovModTweenMax.to(i.htmlContentDO, .8, {x: 0,y: 0,ease: Expo.easeInOut})
            } else {
                i.imageDO.setWidth(e);
                i.imageDO.setHeight(t);
                i.imageDO.setX(-parseInt(e / 2));
                i.imageDO.setY(-parseInt(t / 2));
                FWDR3DCovModTweenMax.to(i.imageDO, .8, {x: 0,y: 0,ease: Expo.easeInOut});
                if (i.reflCanvasDO) {
                    i.reflCanvasDO.setAlpha(0);
                    FWDR3DCovModTweenMax.to(i.reflCanvasDO, .8, {alpha: 1,ease: Expo.easeInOut})
                }
            }
        };
        this.showThumb2D = function() {
            if (!FWDR3DCovUtils.hasTransform2d) {
                ...
                i.imageHolderDO.setWidth(0);
                i.imageHolderDO.setHeight(0);
                FWDR3DCovModTweenMax.to(i.imageHolderDO, .8, {x: r,y: r,w: s,h: o,ease: Expo.easeInOut});
                if (n.showThumbnailsHtmlContent) {
                    if (i.htmlContentDO) {
                ...
                i.imageHolderDO.setWidth(0);
                i.imageHolderDO.setHeight(0);
                FWDR3DCovModTweenMax.to(i.imageHolderDO, .8, {x: i.borderSize,y: i.borderSize,w: s,h: o,ease: Expo.easeInOut});
                if (n.showThumbnailsHtmlContent) {
                    if (i.htmlContentDO) {
                        i.htmlContentDO.setWidth(s);
                        i.htmlContentDO.setHeight(o);
        ...
        this.showThumbIntro2D = function(e, t) {
            ...
            if (!FWDR3DCovUtils.hasTransform2d) {
                ...
                FWDR3DCovModTweenMax.to(i, .8, {x: Math.floor(i.newX + (i.thumbWidth - n) / 2),y: -Math.floor(r / 2),delay: t,ease: Expo.easeOut})
            } else {
                i.setScale2(i.thumbScale);
                i.setX(-i.thumbWidth / 2);
                i.setY(-i.thumbHeight / 2);
                FWDR3DCovModTweenMax.to(i, .8, {x: i.newX,scale: i.thumbScale,delay: t,ease: Quart.easeOut,onComplete: i.setThumbVisibility})
            }
        };
        this.setScale = function(e, t) {
            ...
            if (!FWDR3DCovUtils.hasTransform2d) {
                ...
                if (i.borderDO) {
                    FWDR3DCovModTweenMax.to(i.borderDO, .8, {w: r,h: s,ease: Quart.easeOut})
                }
                if (i.bgDO) {
                    FWDR3DCovModTweenMax.to(i.bgDO, .8, {x: o,y: o,w: r - o * 2,h: s - o * 2,ease: Quart.easeOut})
                }
                FWDR3DCovModTweenMax.to(i.mainDO, .8, {w: r,h: s,ease: Quart.easeOut});
                FWDR3DCovModTweenMax.to(i.imageHolderDO, .8, {x: o,y: o,w: r - o * 2,h: s - o * 2,ease: Quart.easeOut});
                FWDR3DCovModTweenMax.to(i, .8, {x: Math.floor(i.newX + (i.thumbWidth - r) / 2),y: -Math.floor(s / 2),w: r,h: s,alpha: t,ease: Quart.easeOut});
                if (n.showThumbnailsHtmlContent) {
                    if (i.htmlContentDO) {
                        FWDR3DCovModTweenMax.to(i.htmlContentDO, .8, {w: r - o * 2,h: s - o * 2,ease: Quart.easeOut})
                    }
                } else {
                    if (i.imageDO) {
                        FWDR3DCovModTweenMax.to(i.imageDO, .8, {w: r - o * 2,h: s - o * 2,ease: Quart.easeOut})
                    }
                }
            } else {
                FWDR3DCovModTweenMax.to(i, .8, {x: Math.floor(i.newX),scale: i.thumbScale,alpha: t,ease: Quart.easeOut,onComplete: i.setThumbVisibility})
            }
        };
        ...
        this.hide = function(e) {
            ...
            FWDR3DCovModTweenMax.to(i.imageHolderDO, .8, {x: parseInt(i.thumbWidth / 2),y: parseInt(i.thumbHeight / 2),w: 0,h: 0,delay: e,ease: Expo.easeInOut});
            if (n.showThumbnailsHtmlContent) {
                if (i.htmlContentDO) {
                    FWDR3DCovModTweenMax.to(i.htmlContentDO, .8, {x: -parseInt(t / 2),y: -parseInt(r / 2),delay: e,ease: Expo.easeInOut})
                }
            } else {
                if (i.imageDO) {
                    FWDR3DCovModTweenMax.to(i.imageDO, .8, {x: -parseInt(t / 2),y: -parseInt(r / 2),delay: e,ease: Expo.easeInOut});
                    if (i.reflCanvasDO) {
                        FWDR3DCovModTweenMax.to(i.reflCanvasDO, .8, {alpha: 0,delay: e,ease: Expo.easeInOut})
                    }
                }
            }
        };
        this.onMouseClickHandler = function() {
            i.dispatchEvent(t.CLICK, {id: i.id})
        };
        this.onMouseOverHandler = function() {
            if (!i.isOver2 && i.id != r.curId) {
                ...
                FWDR3DCovModTweenMax.to(i, .6, {z: i.curZ + 100,ease: Expo.easeOut})
            }
        };
        this.onMouseOutHandler = function() {
            if (i.isOver2 && i.id != r.curId) {
                i.isOver2 = false;
                if (i.gradientDO) {
                    i.setGradient2(i.pos)
                }
                FWDR3DCovModTweenMax.to(i, .6, {z: i.curZ,ease: Expo.easeOut})
            }
        };
        ...
        this.destroy = function() {
            FWDR3DCovModTweenMax.killTweensOf(i);
            FWDR3DCovModTweenMax.killTweensOf(i.mainDO);
            FWDR3DCovModTweenMax.killTweensOf(i.imageHolderDO);
            if (i.isMobile) {
                if (i.hasPointerEvent) {
                    i.mainDO.screen.removeEventListener("MSPointerUp", i.onMouseTouchHandler)
                } else {
            ...
            if (i.imageDO) {
                FWDR3DCovModTweenMax.killTweensOf(i.imageDO);
                i.imageDO.destroy()
            }
            if (i.htmlContentDO) {
                FWDR3DCovModTweenMax.killTweensOf(i.htmlContentDO);
            ...
            if (i.borderDO) {
                FWDR3DCovModTweenMax.killTweensOf(i.borderDO);
                i.borderDO.destroy();
                i.borderDO = null
            }
            if (i.htmlContentDO) {
            ...
            if (i.gradientLeftDO) {
                FWDR3DCovModTweenMax.killTweensOf(i.gradientLeftDO);
                i.gradientLeftDO.destroy()
            }
            if (i.gradientRightDO) {
                FWDR3DCovModTweenMax.killTweensOf(i.gradientRightDO);
    ...
    t.setPrototype = function() {
        t.prototype = new FWDR3DCovDisplayObject3D("div", "absolute", "visible")
    };
    t.CLICK = "click";
    t.prototype = null;
    e.FWDR3DCovThumb = t
...
(function(e) {
    var t = function(n, r) {
        ...
        this.showControlsId;
        this.init = function() {
            i.thumbsHolderDO = new FWDR3DCovDisplayObject3D("div", "absolute", "visible");
            ...
            if (i.data.controlsPos) {
                i.thumbsHolderDO.setY(Math.floor((i.stageHeight - i.data.prevButtonNImg.height) / 2 + i.controlsHeight))
            } else {
                i.thumbsHolderDO.setY(Math.floor((i.stageHeight - i.data.prevButtonNImg.height) / 2))
            }
            if (!i.isMobile && !FWDR3DCovUtils.isSafari || FWDR3DCovUtils.isAndroidAndWebkit) {
        ...
        this.showCurrentCat = function(e) {
            ...
            if (i.totalThumbs == 0) {
                ...
                i.dispatchEvent(t.LOAD_ERROR, {text: r});
                return
            }
            if (i.isMobile) {
        ...
        this.hideThumbs = function() {
            ...
            for (var s = 0; s < i.totalThumbs; s++) {
                ...
                if (s == i.curId) {
                    ...
                    FWDR3DCovModTweenMax.to(thumb, .5, {x: Math.floor(n),delay: e / 1e3,ease: Expo.easeIn});
        ...
        this.hideThumbsFinished = function() {
            for (var e = 0; e < i.totalThumbs; e++) {
                ...
                if (e == i.curId) {
                    thumb.hide(0);
                    FWDR3DCovModTweenMax.to(thumb, .6, {alpha: 0,delay: .2,onComplete: i.allThumbsAreTweened});
                    if (i.isMobile && i.textHolderDO) {
                        FWDR3DCovModTweenMax.to(i.textHolderDO, .6, {alpha: 0,delay: .2,ease: Expo.easeOut});
                        FWDR3DCovModTweenMax.to(i.textGradientDO, .6, {alpha: 0,delay: .2,ease: Expo.easeOut})
                    }
                } else {
                    thumb.setAlpha(0)
                }
        ...
        this.destroyCurrentCat = function() {
            ...
            for (var t = 0; t < i.totalThumbs; t++) {
                e = i.thumbsAr[t];
                FWDR3DCovModTweenMax.killTweensOf(e);
        ...
        this.setupThumbs = function() {
            ...
            for (var t = 0; t < i.totalThumbs; t++) {
                ...
                e = new FWDR3DCovThumb(t, i.data, i);
                i.thumbsAr.push(e);
                e.addListener(FWDR3DCovThumb.CLICK, i.onThumbClick)
            }
        };
        ...
        this.thumbClickHandler = function() {
            if (i.curId != i.prevCurId) {
                ...
                if (n == "link") {
                    ...
                    i.dispatchEvent(t.THUMB_CLICK, {id: r})
                }
            }
        };
        this.resizeHandler = function() {
            if (i.stageWidth == r.stageWidth && i.stageHeight == r.stageHeight)
                return;
        ...
        this.setupText = function() {
            i.textHolderDO = new FWDR3DCovDisplayObject3D("div");
            ...
            if (i.data.showTextBackgroundImage) {
                i.textGradientDO = new FWDR3DCovSimpleDisplayObject("img");
                ...
                i.textGradientDO = new FWDR3DCovSimpleDisplayObject("div");
                i.textHolderDO.addChild(i.textGradientDO);
                i.textGradientDO.setWidth(i.thumbWidth - i.borderSize * 2);
                i.textGradientDO.setHeight(i.thumbHeight - i.borderSize * 2);
            ...
            i.textDO = new FWDR3DCovSimpleDisplayObject("div");
        ...
        this.setupThumbOver = function() {
            i.thumbOverDO = new FWDR3DCovDisplayObject("div");
        ...
        this.setTextHeight = function() {
            i.textHeight = i.textDO.getHeight();
            FWDR3DCovModTweenMax.to(i.textHolderDO, .8, {alpha: 1,ease: Expo.easeOut});
            FWDR3DCovModTweenMax.to(i.textGradientDO, .8, {alpha: 1,ease: Expo.easeOut});
            i.hasThumbText = true;
            i.checkThumbOver()
        };
        ...
        this.loadImages = function() {
            if (FWDR3DCovUtils.hasTransform3d && !i.data.showDisplay2DAlways) {
                i.setupIntro3D()
            } else {
                i.setupIntro2D()
            }
        ...
        this.onImageLoadErrorHandler = function(e) {
            ...
            i.dispatchEvent(t.LOAD_ERROR, {text: n})
        };
        this.loadHtmlContents = function() {
            ...
            i.setupIntro2D();
            /*if (FWDR3DCovUtils.hasTransform3d && !i.data.showDisplay2DAlways) {
                alert('Called Now for 3D');
                i.setupIntro3D()
            } else {
                alert('Called Now for 2D');
                i.setupIntro2D()
            }*/
            i.countLoadedThumbsLeft = i.curId - 1;
        ...
        this.setupIntro3D = function() {
            ...
            for (var o = 0; o < i.totalThumbs; o++) {
                ...
                if (o != i.curId) {
                    if (i.nrThumbsToDisplay > 0 && Math.abs(o - i.curId) <= i.nrThumbsToDisplay) {
                        e = (i.thumbXSpace3D * Math.abs(o - i.curId) + i.thumbXOffset3D) * u;
                        n = -((i.thumbZSpace3D + 1) * Math.abs(o - i.curId) + i.thumbZOffset3D);
                        r = -i.thumbYAngle3D * u;
                        e *= i.sizeRatio;
                        n *= i.sizeRatio;
                        ...
                        thumb.setZ(n - Math.abs(o - i.curId) * 100);
                        s = Math.abs(o - i.curId) * Math.floor(1e3 / i.nrThumbsToDisplay);
                        if (FWDR3DCovUtils.isIEAndMoreThen9) {
                            FWDR3DCovModTweenMax.to(thumb, .8, {x: Math.floor(e),y: Math.floor(t),z: Math.floor(n),angleY: r,delay: s / 1e3,ease: Quart.easeOut});
                            thumb.setZIndex(i.nrThumbsToDisplay + 1 - Math.abs(o - i.curId))
                        } else {
                            FWDR3DCovModTweenMax.to(thumb, .8, {x: Math.floor(e),y: Math.floor(t),z: Math.floor(n),angleY: r,angleX: .1,delay: s / 1e3,ease: Quart.easeOut})
                        }
                    } else {
                        if (i.nrThumbsToDisplay > 0) {
                            e = (i.thumbXSpace3D * (i.nrThumbsToDisplay + 1) + i.thumbXOffset3D) * u;
                            ...
                            r = -i.thumbYAngle3D * u;
                            if (FWDR3DCovUtils.isIEAndMoreThen9) {
                                thumb.setZIndex(Math.floor(i.totalThumbs / 2) - Math.abs(o - i.curId))
                            }
                        }
                        e *= i.sizeRatio;
                        n *= i.sizeRatio;
                        ...
                        if (i.nrThumbsToDisplay > 0) {
                            ...
                            thumb.setZ(Math.floor(n));
                            s = Math.abs(o - i.curId) * Math.floor(1e3 / (i.totalThumbs / 2));
                            if (FWDR3DCovUtils.isIEAndMoreThen9) {
                                FWDR3DCovModTweenMax.to(thumb, .8, {x: Math.floor(e),y: Math.floor(t),z: Math.floor(n),angleY: r,delay: s / 1e3,ease: Quart.easeOut})
                            } else {
                                FWDR3DCovModTweenMax.to(thumb, .8, {x: Math.floor(e),y: Math.floor(t),z: Math.floor(n),angleY: r,angleX: .1,delay: s / 1e3,ease: Quart.easeOut})
                    ...
                    if (FWDR3DCovUtils.isIEAndMoreThen9) {
                        if (i.nrThumbsToDisplay > 0) {
                            ...
                            thumb.setZIndex(Math.floor(i.totalThumbs / 2))
                        }
                    }
                }
                thumb.setGradient(u);
            ...
            for (var r = 0; r < i.totalThumbs; r++) {
                ...
                if (r != i.curId) {
                    if (Math.abs(r - i.curId) <= i.nrThumbsToDisplay) {
                        ...
                        t = Math.max(.9 - Math.abs(r - i.curId) * .05, .25);
                        e *= i.sizeRatio;
                        ...
                        e = Math.floor(e) - Math.floor(i.thumbWidth / 2);
                        n = Math.abs(r - i.curId) * Math.floor(1e3 / i.nrThumbsToDisplay);
                        thumb.newX = Math.floor(e);
                        thumb.showThumbIntro2D(t, n / 1e3);
                        thumb.setZIndex(i.nrThumbsToDisplay + 1 - Math.abs(r - i.curId))
                    } else {
                        e = (i.thumbXSpace2D * (i.nrThumbsToDisplay + 1) + i.thumbXOffset2D) * s;
                        t = Math.max(.9 - (i.nrThumbsToDisplay + 1) * .05, .25);
                        e *= i.sizeRatio;
                        var o = i.thumbHeight / i.thumbWidth;
                        if (o > .7) {
                            e *= Math.min(1 / o, .8)
        ...
        this.setIntroFinished = function() {
            ...
            if (FWDR3DCovUtils.isIEAndMoreThen9 || !FWDR3DCovUtils.hasTransform3d || i.data.showDisplay2DAlways) {
        ...
        this.gotoThumb = function() {
            ...
            i.dispatchEvent(t.THUMB_CHANGE, {id: i.curId})
        };
        ...
        this.gotoThumb3D = function() {
            ...
            for (var s = 0; s < i.totalThumbs; s++) {
                ...
                if (s != i.curId) {
                    if (i.nrThumbsToDisplay > 0 && Math.abs(s - i.curId) <= i.nrThumbsToDisplay) {
                        e = (i.thumbXSpace3D * Math.abs(s - i.curId) + i.thumbXOffset3D) * o;
                        n = -((i.thumbZSpace3D + 1) * Math.abs(s - i.curId) + i.thumbZOffset3D);
                        r = -i.thumbYAngle3D * o
                    } else {
                        if (i.nrThumbsToDisplay > 0) {
                            e = (i.thumbXSpace3D * (i.nrThumbsToDisplay + 1) + i.thumbXOffset3D) * o;
                            n = -((i.thumbZSpace3D + 1) * (i.nrThumbsToDisplay + 1) + i.thumbZOffset3D);
                            r = -i.thumbYAngle3D * o
                        } else {
                            e = (i.thumbXSpace3D * Math.abs(s - i.curId) + i.thumbXOffset3D) * o;
                ...
                e = Math.floor(e) - Math.floor(i.thumbWidth / 2);
                t = Math.floor(t) - Math.floor(i.thumbHeight / 2);
                if (Math.abs(thumb.curX) != Math.floor(i.thumbXSpace3D * (i.nrThumbsToDisplay + 1) + i.thumbXOffset3D)) {
                    FWDR3DCovModTweenMax.killTweensOf(thumb);
                    if (i.nrThumbsToDisplay > 0 && Math.abs(s - i.curId) <= i.nrThumbsToDisplay) {
                        if (FWDR3DCovUtils.isIEAndMoreThen9) {
                            FWDR3DCovModTweenMax.to(thumb, .8, {x: Math.floor(e),y: Math.floor(t),z: Math.floor(n),angleY: r,alpha: 1,ease: Quart.easeOut})
                        } else {
                            FWDR3DCovModTweenMax.to(thumb, .8, {x: Math.floor(e),y: Math.floor(t),z: Math.floor(n),angleY: r,angleX: .1,alpha: 1,ease: Quart.easeOut})
                        }
                        thumb.enable()
                    } else {
                        if (i.nrThumbsToDisplay > 0) {
                            if (FWDR3DCovUtils.isIEAndMoreThen9) {
                                FWDR3DCovModTweenMax.to(thumb, .8, {x: Math.floor(e),y: Math.floor(t),z: Math.floor(n),angleY: r,alpha: 0,ease: Quart.easeOut})
                            } else {
                                FWDR3DCovModTweenMax.to(thumb, .8, {x: Math.floor(e),y: Math.floor(t),z: Math.floor(n),angleY: r,angleX: .1,alpha: 0,ease: Quart.easeOut})
                            }
                            thumb.disable()
                        } else {
                            if (FWDR3DCovUtils.isIEAndMoreThen9) {
        ...
        this.gotoThumb2D = function() {
            ...
            for (var n = 0; n < i.totalThumbs; n++) {
                ...
                if (Math.abs(n - i.curId) <= i.nrThumbsToDisplay) {
                    if (n != i.curId) {
                        t = Math.max(.9 - Math.abs(n - i.curId) * .05, .25);
                        e = (i.thumbXSpace2D * Math.abs(n - i.curId) + i.thumbXOffset2D) * r;
                        e *= i.sizeRatio;
                        var s = i.thumbHeight / i.thumbWidth;
                        if (s > .7) {
                            e *= Math.min(1 / s, .8)
                        }
                        e = Math.floor(e) - Math.floor(i.thumbWidth / 2);
                    ...
                    e = (i.thumbXSpace2D * (i.nrThumbsToDisplay + 1) + i.thumbXOffset2D) * r;
                    t = Math.max(.9 - (i.nrThumbsToDisplay + 1) * .05, .25);
                    thumb.setScale(t);
                    e *= i.sizeRatio;
                    var s = i.thumbHeight / i.thumbWidth;
        ...
        this.setupControls = function() {
            i.controlsDO = new FWDR3DCovDisplayObject3D("div");
        ...
        this.showControls = function() {
            if (i.data.controlsPos) {
                FWDR3DCovModTweenMax.to(i.controlsDO, .8, {y: 0,ease: Expo.easeOut})
            } else {
                FWDR3DCovModTweenMax.to(i.controlsDO, .8, {y: i.stageHeight - i.controlsHeight,ease: Expo.easeOut})
            }
        };
        ...
        this.setupPrevButton = function() {
            FWDR3DCovSimpleButton.setPrototype();
            i.prevButtonDO = new FWDR3DCovSimpleButton(i.data.prevButtonNImg, i.data.prevButtonSImg);
            i.prevButtonDO.addListener(FWDR3DCovSimpleButton.CLICK, i.prevButtonOnClickHandler);
        ...
        this.setupNextButton = function() {
            FWDR3DCovSimpleButton.setPrototype();
            i.nextButtonDO = new FWDR3DCovSimpleButton(i.data.nextButtonNImg, i.data.nextButtonSImg);
            i.nextButtonDO.addListener(FWDR3DCovSimpleButton.CLICK, i.nextButtonOnClickHandler);
        ...
        this.setupSlideshowButton = function() {
            ...
            i.slideshowButtonDO = new FWDR3DCovSlideshowButton(i.data);
            i.slideshowButtonDO.addListener(FWDR3DCovSlideshowButton.PLAY_CLICK, i.onSlideshowButtonPlayClickHandler);
            i.slideshowButtonDO.addListener(FWDR3DCovSlideshowButton.PAUSE_CLICK, i.onSlideshowButtonPauseClickHandler);
            i.slideshowButtonDO.addListener(FWDR3DCovSlideshowButton.TIME, i.onSlideshowButtonTime);
            ...
            if (i.data.autoplay && i.showSlideshowButton) {
        ...
        this.setupScrollbar = function() {
            ...
            i.scrollbarDO = new FWDR3DCovScrollbar(i.data, i.totalThumbs, i.curId);
            i.scrollbarDO.addListener(FWDR3DCovScrollbar.MOVE, i.onScrollbarMove);
        ...
        this.mobileDragStartTest = function(t) {
            var n = FWDR3DCovUtils.getViewportMouseCoordinates(t);
            if (n.screenY > i.controlsDO.getY())
                return;
        ...
        this.mobileDragMoveTest = function(t) {
            ...
            if (s > 120 || s < 60) {
                if (t.preventDefault)
                    t.preventDefault();
                i.curId = i.dragCurId + Math.floor(-(i.mouseX - i.lastPressedX) / 100 * i.data.swipeSpeed);
                if (i.curId < 0) {
                    i.curId = 0
        ...
        this.update = function(e) {
            if (FWDR3DCovUtils.hasTransform3d) {
                i.thumbXSpace3D = e.xSpace;
                i.thumbXOffset3D = e.xOffset;
                i.thumbYAngle3D = e.yAngle;
                i.thumbZSpace3D = e.zSpace;
                i.thumbZOffset3D = e.zOffset
            } else {
                i.thumbXSpace2D = e.xSpace;
                i.thumbXOffset2D = e.xOffset
            }
            i.nrThumbsToDisplay = e.nrThumbs;
        ...
        this.destroy = function() {
            ...
            i.imageRight = null;
            for (var n = 0; n < i.totalThumbs; n++) {
                FWDR3DCovModTweenMax.killTweensOf(i.thumbsAr[n]);
            ...
            if (i.controlsDO) {
                FWDR3DCovModTweenMax.killTweensOf(i.controlsDO);
...
(function(e) {
    ...
    t.getViewportSize = function() {
        if (t.hasPointerEvent && navigator.msMaxTouchPoints > 1) {
            return {w: document.documentElement.clientWidth || e.innerWidth,h: document.documentElement.clientHeight || e.innerHeight}
        }
        if (t.isMobile)
            return {w: e.innerWidth,h: e.innerHeight};
        return {w: document.documentElement.clientWidth || e.innerWidth,h: document.documentElement.clientHeight || e.innerHeight}
    };
    t.getViewportMouseCoordinates = function(e) {
        var n = t.getScrollOffsets();
        if (e.touches) {
            return {screenX: e.changedTouches[0] == undefined ? e.changedTouches.pageX - n.x : e.changedTouches[0].pageX - n.x,screenY: e.changedTouches[0] == undefined ? e.changedTouches.pageY - n.y : e.changedTouches[0].pageY - n.y}
        }
        return {screenX: e.clientX == undefined ? e.pageX - n.x : e.clientX,screenY: e.clientY == undefined ? e.pageY - n.y : e.clientY}
    };
    ...
    t.resizeDoWithLimit = function(e, t, n, r, i, s, o, u, a, f, l, c, h) {
        ...
        if (f) {
            FWDR3DCovModTweenMax.to(e, l, {x: y,y: b,w: m,h: g,delay: c,ease: h})
        } else {
            e.x = y;
            e.y = b;
            e.w = m;
...
(function(e) {
    var t = function(n) {
        ...
        this.init = function() {
            ...
            if (!r.propsObj.coverflowHolderDivId) {
                alert("Property coverflowHolderDivId is not defined in the FWDRoyal3DCoverflow object constructor!");
                return
            }
            if (!FWDR3DCovUtils.getChildById(r.propsObj.coverflowHolderDivId)) {
                alert("FWDRoyal3DCoverflow holder div is not found, please make sure that the div exists and the id is correct! " + r.propsObj.coverflowHolderDivId);
                return
            }
            if (!r.propsObj.coverflowWidth) {
                alert("The coverflow width is not defined, plese make sure that the coverflowWidth property is definded in the FWDRoyal3DCoverflow constructor!");
                return
            }
            if (!r.propsObj.coverflowHeight) {
                alert("The coverflow height is not defined, plese make sure that the coverflowHeight property is definded in the FWDRoyal3DCoverflow constructor!");
                return
            }
            r.stageContainer = FWDR3DCovUtils.getChildById(r.propsObj.coverflowHolderDivId);
        ...
        this.setupMainDO = function() {
            r.mainDO = new FWDR3DCovDisplayObject("div", "relative");
        ...
        this.setBackgrounds = function() {
            if (r.propsObj.backgroundImagePath) {
                r.bgDO = new FWDR3DCovDisplayObject("div");
                ...
                r.bgDO.setAlpha(0);
                FWDR3DCovModTweenMax.to(r.bgDO, .8, {alpha: 1})
            }
            if (r.propsObj.thumbnailsBackgroundImagePath) {
                r.thumbsBgDO = new FWDR3DCovDisplayObject("div");
                ...
                FWDR3DCovModTweenMax.to(r.thumbsBgDO, .8, {alpha: 1})
            }
            if (r.propsObj.scrollbarBackgroundImagePath) {
                r.scrollbarBgDO = new FWDR3DCovDisplayObject("div");
                ...
                FWDR3DCovModTweenMax.to(r.scrollbarBgDO, .8, {alpha: 1})
            }
        };
        this.setupInfo = function() {
            FWDR3DCovInfo.setPrototype();
            r.infoDO = new FWDR3DCovInfo
        };
        this.startResizeHandler = function() {
            if (e.addEventListener) {
                e.addEventListener("resize", r.onResizeHandler);
        ...
        this.scrollHandler = function() {
            if (!r.orientationChangeComplete)
                return;
            var e = FWDR3DCovUtils.getScrollOffsets();
            r.pageXOffset = e.x;
            r.pageYOffset = e.y;
            if (r.displayType == t.FLUID_WIDTH) {
                if (r.isMobile) {
        ...
        this.resizeHandler = function() {
            if (!r.orientationChangeComplete)
                return;
            var e = FWDR3DCovUtils.getScrollOffsets();
            var n = FWDR3DCovUtils.getViewportSize();
            var i;
            ...
            if (r.preloaderLoaded) {
                ...
                if (r.propsObj.thumbnailsBackgroundImagePath) {
                    ...
                    if (r.data.controlsPos) {
                        r.thumbsBgDO.setY(Math.floor((r.stageHeight - r.originalHeight) / 2 + r.data.nextButtonNImg.height))
                    } else {
        ...
        this.setupContextMenu = function() {
            r.customContextMenuDO = new FWDR3DCovContextMenu(r.mainDO, r.data.showContextMenu)
        };
        this.setupData = function() {
            FWDR3DCovData.setPrototype();
            r.data = new FWDR3DCovData(r.propsObj);
            r.data.addListener(FWDR3DCovData.PRELOADER_LOAD_DONE, r.onPreloaderLoadDone);
            r.data.addListener(FWDR3DCovData.LOAD_ERROR, r.dataLoadError);
            r.data.addListener(FWDR3DCovData.LOAD_DONE, r.dataLoadComplete)
        };
        ...
        this.setupPreloader = function() {
            FWDR3DCovPreloader.setPrototype();
            r.preloaderDO = new FWDR3DCovPreloader(r.data.mainPreloaderImg, 85, 36, 20, 50);
        ...
        this.setupThumbsManager = function() {
            ...
            r.thumbsManagerDO = new FWDR3DCovThumbsManager(r.data, r);
            r.thumbsManagerDO.addListener(FWDR3DCovThumbsManager.THUMB_CLICK, r.onThumbsManagerThumbClick);
            r.thumbsManagerDO.addListener(FWDR3DCovThumbsManager.LOAD_ERROR, r.onThumbsManagerLoadError);
            r.thumbsManagerDO.addListener(FWDR3DCovThumbsManager.THUMBS_INTRO_FINISH, r.onThumbsManagerIntroFinish);
            r.thumbsManagerDO.addListener(FWDR3DCovThumbsManager.THUMB_CHANGE, r.onThumbsManagerThumbChange);
        ...
        this.destroy = function() {
            ...
            if (r.bgDO) {
                FWDR3DCovModTweenMax.killTweensOf(r.bgDO);
                r.bgDO.destroy()
            }
            if (r.thumbsBgDO) {
                FWDR3DCovModTweenMax.killTweensOf(r.thumbsBgDO);
                r.thumbsBgDO.destroy()
            }
            if (r.scrollbarBgDO) {
                FWDR3DCovModTweenMax.killTweensOf(r.scrollbarBgDO);
    ...
    t.CATEGORY_CHANGE = "categoryChange";
    t.THUMB_CHANGE = "thumbChanged";
    e.FWDRoyal3DCoverflow = t
})(window)
